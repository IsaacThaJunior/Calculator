		...
		<div className="outer-div">
			<div className="calc">
				...
				<div className="row first-row">
					<div onClick={reset} className="keys reset">
						C
					</div>
					<div onClick={handleKeyClick} className="num-keys keys border">
						/
					</div>
					<div onClick={handleKeyClick} className="num-keys keys border">
						*
					</div>
					<div onClick={removeChar} className="keys border delete">
						{'<'}{' '}
					</div>
				</div>
				<div className="row other-row">
					<div onClick={handleKeyClick} className="num-keys keys">
						7
					</div>
					<div onClick={handleKeyClick} className="num-keys keys border">
						8
				...
				<div className="row other-row">
					...
					<div onClick={equalTo} className="keys border blue equal">
						=
					</div>
				</div>
			</div>{' '}
